 ...
 * @author acer
 */
public class FormTheLoai extends javax.swing.JDialog  {


    /**
     * Creates new form NXB
     */
    private TheLoaiService sevice = new Theloaiimpl();
    private DefaultTableModel model;

    public FormTheLoai(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        loadData();
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        tl.setMa(ma);
        tl.setTen(ten);
        if (sevice.createTheLoai(tl) == 1) {
            JOptionPane.showMessageDialog(this, "Them thanh cong the loai");
        } else {
    ...
    private void tblTheLoaiMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblTheLoaiMouseClicked
        ...
        TheLoai tl = this.sevice.getAll().get(selectedRow);
        txtMa.setText(tl.getMa());
        txtTen.setText(tl.getTen());
        txtID.setText(tl.getId());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormTheLoai dialog = new FormTheLoai(new javax.swing.JFrame(), true);
    ...
    private void loadData() {
        ...
        model.setRowCount(0);
        List<TheLoai> list = sevice.getAll();
        for (TheLoai tl : list) {
            model.addRow(new Object[]{tl.getId(), tl.getMa(), tl.getTen()});
        }
    }
